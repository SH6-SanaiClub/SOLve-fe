...
export function ComponentPreviewPage() {
  ...
  return (
    <AppPageLayout title="컴포넌트 프리뷰" currentTab="home">
      <Card>
        <SectionHeader title="공통 컴포넌트 미리보기" meta="피그마 기준 샘플" />
        <p className="mt-2 text-sm leading-6 text-font-sub">
          화면에서 반복되는 기본 컴포넌트만 모아둔 확인용 페이지입니다.
        </p>
      </Card>

      <Card title="Buttons">
        <div className="flex flex-col gap-3">
          <Button variant="primary" fullWidth>메인 버튼</Button>
          <Button variant="outline" fullWidth>아웃라인 버튼</Button>
          <div className="flex gap-3">
            <Button variant="sub" className="flex-1">보조 버튼</Button>
            <Button variant="gray" className="flex-1" disabled>비활성 버튼</Button>
          </div>
